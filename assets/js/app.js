...
var beaverCreek = exports.beaverCreek = {
  key: 1,
  title: "Beaver Creek",
  coords: {
    lat: 44.520751829252326,
    lng: -124.06972142855835
  },
  directions: "https://bit.ly/2JMfcfE"
};

var cannonQuarry = exports.cannonQuarry = {
  key: 2,
  title: "Cannon Quarry County Park",
  coords: {
    lat: 44.6044035,
    lng: -123.90223739999999
  },
  directions: "https://bit.ly/2ItECOu"
};

var elkCity = exports.elkCity = {
  key: 3,
  title: "Elk City Campground",
  coords: {
    lat: 44.6205692,
    lng: -123.8749353
  },
  directions: "https://bit.ly/2uIG9y9"
};

var obf = exports.obf = {
  key: 4,
  title: "Oregon Boating Foundation",
  coords: {
    lat: 44.6309395,
    lng: -124.0433969
  },
  directions: "https://bit.ly/2JdwSkG"
};

var olalla = exports.olalla = {
  key: 5,
  title: "Olalla Reservoir",
  coords: {
    lat: 44.681973230765124,
    lng: -123.92838015134276
  },
  directions: "https://bit.ly/2JgwmT3"
};

var portOfToledo = exports.portOfToledo = {
  key: 6,
  title: "Port of Toledo Marina",
  coords: {
    lat: 44.6184992,
    lng: -123.937745
  },
  directions: "https://bit.ly/2q0ZtRi"
};

var toledoPool = exports.toledoPool = {
  key: 7,
  title: "Toledo Swimming Pool",
  coords: {
    lat: 44.62590955,
    lng: -123.93836215
  },
  directions: "http://bit.ly/2QpDlv6"
};
...
var generateMarkers = function generateMarkers(map, locations) {
  var markers = {};

  var showInfoWindow = function showInfoWindow(content, map, marker) {
  ...
  try {
    var _loop = function _loop() {
      ...
      var key = 'loc' + location.key;
      markers[key] = {};

      markers[key]['content'] = '<div class="map-info-window"><p><strong>' + location.title + '</strong><br>' + '<a href="' + location.directions + '" target="_blank">Get directions</a>' + '</p></div>';

      // TODO: Create a global window
      ...
      markers[key]['marker'].addListener('click', function () {
        showInfoWindow(markers[key]['content'], map, markers[key]['marker']);
      });

      $('.map-info-' + location.key).click(function () {
        showInfoWindow(markers[key]['content'], map, markers[key]['marker']);
      });
    };
...
exports.default = generateMarkers;
...
var _whatInput = __webpack_require__(6);
...
var _hashlinks = __webpack_require__(18);

var _hashlinks2 = _interopRequireDefault(_hashlinks);

var _cognito = __webpack_require__(7);
...
(0, _jquery2.default)(document).ready(function () {
  (0, _maps2.default)();
  (0, _cognito2.default)();
  (0, _hashlinks2.default)();
  (0, _mailchimp2.default)();
});
...
var setupCognitoForm = function setupCognitoForm() {
  if (document.getElementById('contact-form')) {
    Cognito.load("forms", { id: "1" });
  }
};

exports.default = setupCognitoForm;
...
var validateMailchimpForm = function validateMailchimpForm() {
  window.fnames = new Array();window.ftypes = new Array();fnames[0] = 'EMAIL';ftypes[0] = 'email';fnames[1] = 'FNAME';ftypes[1] = 'text';fnames[2] = 'LNAME';ftypes[2] = 'text';fnames[3] = 'LAST_ORDER';ftypes[3] = 'date';fnames[4] = 'COMPANY';ftypes[4] = 'text';fnames[5] = 'PHONE';ftypes[5] = 'phone';fnames[6] = 'ADDRESS';ftypes[6] = 'address';fnames[7] = 'TAGS';ftypes[7] = 'text';
};

exports.default = validateMailchimpForm;
...
var _markers = __webpack_require__(1);

var _markers2 = _interopRequireDefault(_markers);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var advKayakCampMap = function advKayakCampMap() {
  var element = document.getElementById('advanced-kayak-camp-map');
  var locations = [_locations.obf];
  var map = new google.maps.Map(element, {
    zoom: 14,
    center: _locations.obf.coords,
    disableDefaultUI: true,
    mapTypeId: 'roadmap',
    zoomControl: true
  });
  (0, _markers2.default)(map, locations);
};

exports.default = advKayakCampMap;
...
var begKayakCampMap = function begKayakCampMap() {
  var element = document.getElementById('beginner-kayak-camp-map');
  var locations = [_locations.beaverCreek, _locations.olalla, _locations.portOfToledo];
  var map = new google.maps.Map(element, {
    zoom: 10,
    center: _locations.portOfToledo.coords,
    disableDefaultUI: true,
    mapTypeId: 'roadmap',
    zoomControl: true
  });
...
exports.default = begKayakCampMap;
...
var freeFamilyBoatingMap = function freeFamilyBoatingMap() {
  var element = document.getElementById('free-family-boating-map');
  var locations = [_locations.portOfToledo];
  var map = new google.maps.Map(element, {
    zoom: 15,
    center: _locations.portOfToledo.coords,
    disableDefaultUI: true,
...
exports.default = freeFamilyBoatingMap;
...
var _contactMap = __webpack_require__(11);

var _contactMap2 = _interopRequireDefault(_contactMap);

var _beginnerKayakCampMap = __webpack_require__(10);

var _beginnerKayakCampMap2 = _interopRequireDefault(_beginnerKayakCampMap);

var _intermediateKayakCampMap = __webpack_require__(14);

var _intermediateKayakCampMap2 = _interopRequireDefault(_intermediateKayakCampMap);

var _advancedKayakCampMap = __webpack_require__(9);

var _advancedKayakCampMap2 = _interopRequireDefault(_advancedKayakCampMap);

var _sailingCampMap = __webpack_require__(16);

var _sailingCampMap2 = _interopRequireDefault(_sailingCampMap);

var _freeFamilyBoatingMap = __webpack_require__(12);

var _freeFamilyBoatingMap2 = _interopRequireDefault(_freeFamilyBoatingMap);

var _kayakClassMap = __webpack_require__(15);

var _kayakClassMap2 = _interopRequireDefault(_kayakClassMap);

var _toledoPoolMap = __webpack_require__(17);

var _toledoPoolMap2 = _interopRequireDefault(_toledoPoolMap);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var initMap = function initMap() {
  if (document.getElementById('contact-map')) {
    (0, _contactMap2.default)();
  }
  if (document.getElementById('beginner-kayak-camp-map')) {
    (0, _beginnerKayakCampMap2.default)();
  }
  if (document.getElementById('intermediate-kayak-camp-map')) {
    (0, _intermediateKayakCampMap2.default)();
  }
  if (document.getElementById('advanced-kayak-camp-map')) {
    (0, _advancedKayakCampMap2.default)();
  }
  if (document.getElementById('sailing-camp-map')) {
    (0, _sailingCampMap2.default)();
  }
  if (document.getElementById('free-family-boating-map')) {
    (0, _freeFamilyBoatingMap2.default)();
  }
  if (document.getElementById('kayak-class-map')) {
    (0, _kayakClassMap2.default)();
  }
  if (document.getElementById('toledo-pool-map')) {
    (0, _toledoPoolMap2.default)();
  }
};
...
var intKayakCampMap = function intKayakCampMap() {
  var center = {
    lat: 44.649319,
    lng: -123.90325942719727
  };
  var element = document.getElementById('intermediate-kayak-camp-map');
  var locations = [_locations.cannonQuarry, _locations.elkCity, _locations.obf, _locations.olalla, _locations.portOfToledo];
  var map = new google.maps.Map(element, {
    zoom: 11,
    center: center,
    disableDefaultUI: true,
...
exports.default = intKayakCampMap;
...
var kayakClassMap = function kayakClassMap() {
  var element = document.getElementById('kayak-class-map');
  var locations = [_locations.olalla];
  var map = new google.maps.Map(element, {
    zoom: 14,
    center: _locations.olalla.coords,
    disableDefaultUI: true,
    mapTypeId: 'roadmap',
    zoomControl: true
  });
...
var sailingCampMap = function sailingCampMap() {
  var element = document.getElementById('sailing-camp-map');
  var locations = [_locations.portOfToledo];
  var map = new google.maps.Map(element, {
    zoom: 15,
    center: _locations.portOfToledo.coords,
...
exports.default = sailingCampMap;
...
var toledoPoolMap = function toledoPoolMap() {
  var element = document.getElementById('toledo-pool-map');
  var locations = [_locations.toledoPool];
  var map = new google.maps.Map(element, {
    zoom: 15,
    center: _locations.toledoPool.coords,
    disableDefaultUI: true,
    mapTypeId: 'roadmap',
    zoomControl: true
  });
...
var setupHashLinks = function setupHashLinks() {
  (0, _jquery2.default)("a[href='#']").click(function (e) {
    e.preventDefault();
  });
};

exports.default = setupHashLinks;
